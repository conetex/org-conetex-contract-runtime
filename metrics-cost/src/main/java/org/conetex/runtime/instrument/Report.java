...
public class Report {
    ...
    public static void main(String[] args){
        ...
        ResultLongDividedByInt resultP1  = Arithmetics.calculateWeightedAverage(positiveDigits1 , weightsPN);
        System.out.println(resultP1.value() + "." + resultP1.fraction() + " <-----    positiveDigits == -1*");

        long[] negativeDigits1  = { -8L   , -5L };
        ResultLongDividedByInt resultN1  = Arithmetics.calculateWeightedAverage(negativeDigits1 , weightsPN);
        System.out.println(resultN1.value() + "." + resultN1.fraction() + " <-----    negativeDigits");

        long[] positiveDigits0  = new long[]{  8L   ,  11L };
        ResultLongDividedByInt resultP0  = Arithmetics.calculateWeightedAverage(positiveDigits0 , weightsPN);
        System.out.println(resultP0.value() + "." + resultP0.fraction() + " <-----    positiveDigits  == -1*");

        long[] negativeDigits0  = new long[]{ -8L   , -11L };
        ResultLongDividedByInt resultN0  = Arithmetics.calculateWeightedAverage(negativeDigits0 , weightsPN);
        System.out.println(resultN0.value() + "." + resultN0.fraction() + " <-----    negativeDigits");


        long[] positiveDigits2  = {  8L   ,  8L-13L };
        ResultLongDividedByInt resultP2  = Arithmetics.calculateWeightedAverage(positiveDigits2 , weightsPN);
        ...
        ResultLongDividedByInt resultN2  = Arithmetics.calculateWeightedAverage(negativeDigits2 , weightsPN);
        ...
        int[] weights     = {  1    ,  1            ,  1            , 1      };
        ResultLongDividedByInt result10 = Arithmetics.calculateWeightedAverage(digits10, weights);
        ResultLongDividedByInt result1  = Arithmetics.calculateWeightedAverage(digits1 , weights);
        ...
        ResultLongDividedByInt w0Result10 = Arithmetics.calculateWeightedAverage(w0Digits10, w0Weights);
        ResultLongDividedByInt w0Result1  = Arithmetics.calculateWeightedAverage(w0Digits1 , w0Weights);
        ...
        ResultLongDividedByInt w1Result10 = Arithmetics.calculateWeightedAverage(w1Digits10, w1Weights);
        ResultLongDividedByInt w1Result1  = Arithmetics.calculateWeightedAverage(w1Digits1 , w1Weights);
        ...
        ResultLongDividedByInt w2Result10 = Arithmetics.calculateWeightedAverage(w2Digits10, w2Weights);
        ResultLongDividedByInt w2Result1  = Arithmetics.calculateWeightedAverage(w2Digits1 , w2Weights);
        ...
        ResultLongDividedByInt w3NewResult10 = Arithmetics.calculateWeightedAverage(w3NewDigits10, w3NewWeights);
        ResultLongDividedByInt w3NewResult1  = Arithmetics.calculateWeightedAverage(w3NewDigits1 , w3NewWeights);
        ...
        ResultLongDividedByInt w3Result10 = Arithmetics.calculateWeightedAverage(w3Digits10, w3Weights, 10);
        ResultLongDividedByInt w3Result1  = Arithmetics.calculateWeightedAverage(w3Digits1 , w3Weights, 10);
        ...
        ResultLongDividedByInt w4Result10 = Arithmetics.calculateWeightedAverage(w4Digits10, w4Weights);
        ResultLongDividedByInt w4Result1  = Arithmetics.calculateWeightedAverage(w4Digits1 , w4Weights);
        ...
        ResultLongDividedByInt w4Result10b = Arithmetics.calculateWeightedAverage(10, w4Digits10b, w4WeightsB); // but to get an understandable fraction, weightsSum has not to be 10.
        ResultLongDividedByInt w4Result1b  = Arithmetics.calculateWeightedAverage(10, w4Digits1b , w4WeightsB); // we can achieve this by setting scale to 10.
    ...
    public static ResultLongDividedByInt[] calculateTotalCost(RetransformingClassFileTransformer transformer) {
        return transformer.getConfig().calculateWeightedAverages();
    }
